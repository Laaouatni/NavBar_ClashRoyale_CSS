...
let hints = [
    ...
    'All Cards can be upgraded to level 14 - that'
    s the max level.
    ',
    'Break the Dark Prince'
    s shield first, then you can start to whittle down his hitpoints.
    ',
    ...
    'Despite the Ice Wizard being freezing cold, he has a handlebar moustache that'
    s too hot
    for TV.
    ',
    'Donating cards to your Clan gives experience and Gold, and makes you feel all warm and fuzzy inside.',
    'Don'
    t run with a mouthful of Double Trouble Gum!Unless you 've had years of didgeridoo lessons.',
    'During a 2v2 Battle, your teammate'
    s cards and Elixir are shown next to their name.
    ',
    'Elixir production is doubled during the final 60 seconds.',
    'Epic Chests can be won from battle, but they'
    re incredibly rare!',
    'Giant Chests can be won from battle, but they'
    re quite rare!',
    ...
    'If you'
    re feeling warm feelings towards the Princess, it 's probably because you'
    re on fire.
    ',
    'If you'
    ve been playing Clash Royale
    for a
    while, consider taking a
    break !',
    ...
    'In 2v2 Battle, your opponents are selected based on your team'
    s skill level.
    ',
    'Legendary Cards can appear in the Shop once you'
    ve reached Arena 10. ',
    'Legendary Chests can be won from battle, but they'
    re incredibly rare!',
    ...
    'Make sure to check the Shop each day to see what'
    s new !',
    ...
    'Overkill isn'
    t in Sparky 's vocabulary.',
    'P.E.K.K.A: No-one knows what'
    s behind that mask.Maybe even another mask.
    ',
    ...
    'Sometimes it'
    s worth pushing
    for a three - Crown victory.Sometimes securing two Crowns is the smarter play.
    ',
    ...
    'The Miner can burrow his way underground and appear anywhere in the Arena. It'
    s not magic, it 's a shovel.',
    ...
    'Trophies that you win are deducted from your opponent'
    s Trophies!',
    ...
    'We'
    ve done the math: 2 v2 Battle is at least twice the fun of anything
    else .Probably more.
    ',
    'When you reach a new Arena, a special one-time "Arena Pack" will be available to purchase from the Shop.',
    'X-Bows and Mortars can directly damage your opponent'
    s Crown Towers
    if positioned near the middle.
    ',
    'You can'
    t Clone a Clone.
    ',
